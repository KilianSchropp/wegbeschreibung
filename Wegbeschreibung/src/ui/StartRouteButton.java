...
public class StartRouteButton extends JButton implements ActionListener
{
    ...
    {
        int index = fastestRoute.indexOf(getSplitPoint(room, fastestRoute));
        if(index != -1)
        {
    ...
    private Object getSplitPoint(GraphPoint room, LinkedList<GraphPoint> fastestRoute)
    {
